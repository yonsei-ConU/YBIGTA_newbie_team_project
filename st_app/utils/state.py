...
Route = Literal["chat_node", "subject_info_node", "rag_review_node", "end"]


class State(TypedDict, total=False):
    """
    그래프 세션 상태 정의함. 메시지, 사용자 입력, 라우팅 결과, 
    검색 문서 등 저장함. 노드 간 공용으로 읽고 쓰게 됨.
    """
...
def new_state() -> State:
    """
    초기 상태 객체 생성함. 시작 시 chat으로 라우팅하고 
    비어 있는 로그로 시작함.
    """
    return {
        "messages": [], 
